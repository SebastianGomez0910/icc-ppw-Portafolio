...
export interface ApiProgramadorProgramador extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::programador.programador'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    profilePicture: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    projectType: Schema.Attribute.Enumeration<['Academico', 'Personal', 'Laboral', 'Simulado']>;
    publishedAt: Schema.Attribute.DateTime;
    repositorioUrl: Schema.Attribute.String;
    shortDescription: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'name'>;
    teechnologies: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
